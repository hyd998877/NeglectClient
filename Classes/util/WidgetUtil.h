...
namespace WidgetUtil {
    static cocos2d::ui::Widget* widgetHeaderFromJsonFile(const std::string &fileName) {
    ...
    static cocos2d::ui::Widget* widgetFotterFromJsonFile(const std::string &fileName) {
        const cocos2d::Size visibleSize = cocos2d::Director::getInstance()->getVisibleSize();
